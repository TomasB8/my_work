...
/**
 * Trieda <code>HungerPointer</code> slúži na vypísanie hladu v triede {@link SlowSimulation}.
 ...
 * @see NeedsChecker
 */
public class HungerPointer implements NeedsChecker{
    private final TravelGUI pane;
    private final Traveller traveller;

    public HungerPointer(TravelGUI pane, Traveller traveller){
        this.pane = pane;
        this.traveller = traveller;
    }

    /**
     * Metóda vypisujúca hodnotu hladu.
    ...
    public void show(){
        ...
        pane.getHunger().setText("Hlad: " + lambdaRound.round(traveller.getHunger()) + "/100");
    }
}
